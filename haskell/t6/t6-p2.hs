...
doMatrix :: Float -> Float -> Float -> Float -> String -> Float -> Float -> [(String,Rect)]
doMatrix lineNumber columnNumber rectWidth rectHeight hue xStart yStart =
  let --Lista de tupla com os valores de sat e light

 ...
 * ThreadDemo.java
 *
 * Created on Nov 9, 2011, 4:52:40 PM
 */
package threaddemo;
 ...
 * @author andrea
 */
public final class ThreadDemo extends javax.swing.JFrame {
    ...
    JTextArea getTextArea(int threadId) {
        if (threadId == 0) {
            return textArea0;
        }
        if (threadId == 1) {
